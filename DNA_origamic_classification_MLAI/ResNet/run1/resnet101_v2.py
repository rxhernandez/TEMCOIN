...
with open("training_results_res101_v2.csv", mode='w', newline='') as file:
...
torch.save(resnetNN.state_dict(), './resnet101_trained.pth')
...
state_dict = torch.load('./resnet101_trained.pth')
...
torch.save(resnetNN.state_dict(), './fine_tuned_resnet101.pth')
