...
with open("training_results_res152_v2.csv", mode='w', newline='') as file:
...
torch.save(resnetNN.state_dict(), './resnet152_trained.pth')
...
state_dict = torch.load('./resnet152_trained.pth')
...
torch.save(resnetNN.state_dict(), './fine_tuned_resnet152.pth')
...
state_dict = torch.load('./fine_tuned_resnet152.pth')
